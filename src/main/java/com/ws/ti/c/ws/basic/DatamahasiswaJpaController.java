...
import com.ws.ti.c.ws.basic.exceptions.NonexistentEntityException;
import com.ws.ti.c.ws.basic.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.ws.ti.c_ws.basic_jar_0.0.1-SNAPSHOTPU");
